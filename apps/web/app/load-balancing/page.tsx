...
export default function LoadBalancingPage() {
  ...
  const [status, setStatus] = useState<PolicyStatus | null>(null); const [routers, setRouters] = useState<Router[]>([]);
