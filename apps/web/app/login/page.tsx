...
export default function LoginPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!isLoginResponse(payload)) throw new Error('The server returned an invalid authentication response.');
...
function isLoginResponse(value: unknown): value is LoginResponse {
  ...
  return typeof record.accessToken === 'string' && typeof record.user === 'object' && record.user !== null && typeof record.tenant === 'object' && record.tenant !== null;
}
