...
export class NetworkCredentialsDto {
  ...
  @IsOptional() @IsString() @MaxLength(300) clientId?: string;
...
export class CreateRouterDto {
  ...
  @IsOptional() @IsString() @MaxLength(80) osVersion?: string;
  @IsOptional() @IsUUID() locationId?: string;
  @IsOptional() @IsUrl({ protocols: ['https', 'http'], require_protocol: true }) @MaxLength(300) apiEndpoint?: string;
...
export class UpdateRouterDto {
  ...
  @IsOptional() @IsString() @MaxLength(80) osVersion?: string;
  @IsOptional() @IsUUID() locationId?: string;
  @IsOptional() @IsBoolean() clearLocation?: boolean;
...
export class RouterHeartbeatDto {
  @IsOptional() @IsIn(['ONLINE', 'DEGRADED', 'OFFLINE']) status?: 'ONLINE' | 'DEGRADED' | 'OFFLINE';
  @IsOptional() @IsInt() @Min(0) @Max(2147483647) activeUsers?: number;
}
